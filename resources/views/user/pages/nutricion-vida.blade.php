...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 rounded-lg ">
        <div class="border-2 border-dashed border-zinc-400 p-4 relative">
            ...
            <img src="https://placehold.co/300x300" alt="Informative" class="w-full h-auto" /><div class="flex justify-end gap-3">
          ...
          <div class="border-2 border-dashed border-zinc-400 p-4 relative">
            ...
            <img src="https://placehold.co/300x300" alt="Menu of the Day" class="w-full h-auto" />
            <button class="btn text-white" style="background-color: rgb(48, 79, 157)" >Agregar Nuevo</button>
          </div>
          ...
          <div class="border-2 border-dashed border-zinc-400 p-4 relative">
            ...
            <img src="https://placehold.co/300x300" alt="Healthy Option" class="w-full h-auto" />
            <button class="btn text-white" style="background-color: rgb(48, 79, 157)" >Agregar Nuevo</button>
          </div>
        </div>
