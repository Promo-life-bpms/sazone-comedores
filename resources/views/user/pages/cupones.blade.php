...
@section('content')
    ...
    <dialog id="my_modal_3" class="modal">
        <div class="modal-box space-y-3">
            ...
            <h3 class="font-bold text-lg text-center">Cupon Chillis, PF CHANGS Itallianis 15%</h3>
    ...
    <dialog id="my_modal_4" class="modal">
        <div class="modal-box space-y-3">
            ...
            <h3 class="font-bold text-lg text-center">Cupon Chillis, PF CHANGS Itallianis 20%</h3>
            <div class="flex justify-center w-full">
                <div class="relative">
                    <img src="https://cdn.britannica.com/17/155017-050-9AC96FC8/Example-QR-code.jpg" alt=""
                        class="h-52">
