...
@section('content')
    ...
    <div class="flex justify-between items-center">
        ...
        <button class="btn text-white" style="background-color: rgb(48, 79, 157)" onclick="my_modal_2.showModal()">Crear
            nuevo</button>
    ...
    <dialog id="my_modal_2" class="modal">
        <div class="modal-box">
            ...
            <form method="POST" action="{{ route('admin.store.admin') }}" enctype="multipart/form-data" class="space-y-3">
                        ...
                        <div class="col-span-1">
                            @foreach ($diningRooms as $diningRoom)
                                @if ($diningRoom->statusV == 1)
                                    <label>
                                        <input type="checkbox" name="dining_rooms[{{ $diningRoom->id }}]"
                                            value="{{ $diningRoom->id }}">
                                        {{ $diningRoom->name }}
                                    </label><br>
                                @endif
                ...
                <div class="space-y-2">
                    <button class="btn w-full uppercase text-white" style="background-color: rgb(48, 79, 157)"
    ...
    <dialog id="my_modal_5" class="modal">
        <div class="modal-box">
            ...
            <form method="POST" action="{{ route('admin.update.admin') }}" class="space-y-3">
                ...
                <div class="space-y-2">
                    <button class="btn text-white w-full uppercase" style="background-color: rgb(48, 79, 157)"
                        type="submit">Guardar</button>
                </div>
            </form>
        </div>
